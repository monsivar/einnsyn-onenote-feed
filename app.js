/*
 * The app deliberately reads the shared meeting catalog at runtime.
 * The catalog is the webapp's single meeting/case data source; the RSS feed
 * remains available for the existing recommendation/detail surface.
 */
